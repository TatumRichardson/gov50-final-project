...
Research Question: How does the gender of incarcerated individuals influence their levels of support for controversial political topics, specifically: an assault weapons ban, marijuana legalization, raising the minimum wage, and tightening border security?
...
## Stances of Incarcerated Individuals on Controversial Policy Proposals  - Dependent Variable
...
ggplot(incarceration, aes(x = stance_on_tightening_border_security)) +
  ...
  labs(
    title = "Stance on Tightening Border Security",
    x = "Response",
    y = "Count"
  ) +
  scale_x_discrete()
...
ggplot(incarceration, aes(x = stance_on_marijuana_legalization)) +
  ...
  labs(
    title = "Stance on Marijuana Legalization",
    x = "Response",
    y = "Count"
  ) +
  scale_x_discrete()
...
ggplot(incarceration, aes(x = stance_on_raise_min_wage)) +
  ...
  labs(
    title = "Stance on Raising the Minimum Wage",
    x = "Response",
    y = "Count"
  ) +
  scale_x_discrete()
...
ggplot(incarceration, aes(x = stance_on_assault_weapons_ban)) +
  ...
  labs(
    title = "Stance on an Assault Weapons Ban",
    x = "Response",
    y = "Count"
  ) +
  scale_x_discrete()
...
ggplot(incarceration, aes(x = factor(Gender), fill = factor(Gender))) +
  geom_bar() +
  labs(
    title = "Count of Men and Women in the Data",
    x = "Gender",
    y = "Count"
  ) +
  scale_x_discrete() +
